...
<div id="middle">
    ...
    <div class="right"  id="mainFrame">
        ...
        <div class="right_cont">
            ...
            <div class="title_right"><strong>车辆费用记录修改</strong></div>
            <div style="width:900px; margin:auto">
                <table class="table table-bordered" >
                    <form method="post" action="${pageContext.request.contextPath }/operation/modify ">
                        <tr>
                            <input type="hidden" name="id" value="${f35carOperation.id}" />
                            <td width="12%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">车牌号：</td>
                            <td><input type="text" name="chepaihao" id="input1" class="span1-1" value="${f35carOperation.chepaihao}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">驾驶人：</td>
                            <td><input type="text" name="jiashiyuan" id="input2" class="span1-1" value="${f35carOperation.jiashiyuan}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">过路费：</td>
                            <td><input type="text" name="guolufei" id="input3" class="span1-1" value="${f35carOperation.guolufei}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">洗车费：</td>
                            <td><input type="text" name="xichefei" id="input4" class="span1-1" value="${f35carOperation.xichefei}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">停车费：</td>
                            <td><input type="text" name="tingchefei" id="input5" class="span1-1" value="${f35carOperation.tingchefei}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">加水费：</td>
                            <td><input type="text" name="jiashuifei" id="input6" class="span1-1" value="${f35carOperation.jiashuifei}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" nowrap="nowrap" bgcolor="#f1f1f1">加油费：</td>
                            <td><input type="text" name="jiayoufei" id="input7" class="span1-1" value="${f35carOperation.jiayoufei}"  /></td>
                        </tr>
                        <tr>
                            <td align="right" bgcolor="#f1f1f1">报销日期：</td>
                            <td><input type="text" name="baoxiaoriqi" class="laydate-icon span1-1" id="Calendar" value="<fmt:formatDate value='${f35carOperation.baoxiaoriqi}' pattern='yyyy-MM-dd' />"  /></td>
                        </tr>
                        <tr>
