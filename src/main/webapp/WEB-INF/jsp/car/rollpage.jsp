...
<body>
		 ...
		 <span class="page-go-form"><label style="display: inline-block">跳转至</label>
	     <input type="text" name="inputPage" id="inputPage" class="page-key" style="display: inline-block"  />页
	     <button type="button" style="display: inline-block" class="page-btn" onClick='jump_to(document.forms[0],document.getElementById("inputPage"))'>GO</button>
		</span>
		</div> 
</body>
