        ...
        <div class="right_cont">
            ...
            <div  style="width:900px; margin:auto" class="text-left">
                <form method="post" action="/user/userlist">
                    ...
                    <%--<a href="carAdd" class="btn btn-info " style="margin-left: 350px" >添加角色</a>--%>
                </form>
            ...
            <div style="width:900px; margin:auto">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>角色名</strong></td>
                        <!-- <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>拥有权限</strong></td> -->
                        <td align="center" nowrap="nowrap" bgcolor="#f1f1f1"><strong>人数</strong></td>
                    ...
                    <c:forEach var="roleList" items="${roleList}" varStatus="status">
                        <tr>
                            ...
                            <td align="center">${roleList.role}</td>
                            <%-- <td align="center">${cusList.cSex}</td> --%>
                            <td align="center">${roleList.roleStaffNum}</td>
                            <!-- <td align="center">&nbsp;</td> -->
                            <%-- <td align="center">
